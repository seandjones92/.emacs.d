...
selections. It's a much better way to interact with Emacs. Since this
package can take a lot of customization I will break it out into
chunks and explain along the way.
#+BEGIN_SRC emacs-lisp
  (defun my-helm-setup ()
    (require 'helm-config)
